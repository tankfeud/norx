...
nim c --compileOnly -d:useMalloc --dynlibOverride:orxd --dynlibOverride:orx --dynlibOverride:orxp --cpu:amd64 --os:android -d:androidNDK -d:noSignalHandler --noMain:on -d:androidnative --nimcache:$PWD/cache norxdemo.nim
