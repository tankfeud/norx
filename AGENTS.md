...
- `src/basics.nim`, `src/vector.nim`, `src/display.nim`, and `src/joystick.nim` provide hand-written Nim APIs for C macros, inline functions, and higher-level conveniences.
